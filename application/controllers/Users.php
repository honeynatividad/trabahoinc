...
class Users extends CI_Controller {
            ...
            if($this->session->userdata('isUserLoggedIn')){
                ...
                if($this->input->post('submit')){
                    ...
                    $userData = array(
                        ...
                        $insert = $this->user->updateUser($userData,$id);
                        if($insert){
                            $this->session->set_userdata('success_msg', 'You successfully updated your account.');
    ...
    public function login(){
        ...
        $this->load->view('users/login/login', $data);
    ...
    public function registration(){
        ...
        //load the view
        $this->load->view('template/header');
        $this->load->view('users/register/register', $data);
        $this->load->view('template/footer');
    }
